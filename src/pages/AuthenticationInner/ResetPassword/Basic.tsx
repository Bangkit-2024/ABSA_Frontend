...
const BasicResetPassword = () => {
    ...
    React.useEffect(() => {
        ...
        bodyElement.classList.add('flex', 'items-center', 'justify-center', 'min-h-screen', 'py-8', 'lg:py-5', 'bg-gray-200', 'dark:bg-zink-800', 'dark:text-zink-100', 'font-public');

        return () => {
            bodyElement.classList.remove('flex', 'items-center', 'justify-center', 'min-h-screen', 'py-8', 'lg:py-5', 'bg-gray-200', 'dark:bg-zink-800', 'dark:text-zink-100', 'font-public');
        }
    }, []);
                ...
                <div className="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 dark:shadow-zink-500/20 relative">
                    <div className="!px-10 !py-12 card-body">
                        ...
                        <div className="text-center">
                            ...
                            <p className="mb-8 text-slate-500 dark:text-zink-200">Enter your email address below and we'll send you a link to reset your password.</p>
                        </div>
                        ...
                        <form autoComplete="off" action="/">
                            ...
                            <div className="mt-4 text-center">
                                <p className="mb-0">I remember my password <Link to="/login" className="underline fw-medium text-custom-500"> Click here </Link> </p>
                            </div>
                        </form>
                    </div>
                </div>
